...
if (isset($_POST["register_btn"])) {
    ...
    if ($body->success) {
        ...
        echo '<script>alert("Register failed. Please check your credentials.");</script>';
    }
}
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="register.php">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button name="register_btn" type="submit" class="btn btn-primary btn-block">Create Account</button></div>
                                            </div>
                                        </form>
                                    </div>
