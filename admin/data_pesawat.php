        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Tiket Pesawat</h1>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-primary btn-xl mb-4" data-bs-toggle="modal" data-bs-target="#tambahModal">Tambah</button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="controller.php">
                                                            ...
                                                            <input type="hidden" name="pesawatId" value=<?= $data->id; ?>>
                                                            <button type="submit" name="hapus_data_pesawat" class="btn btn-danger">Delete</button>
                                                        </form>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="controller.php" method="post">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="nama_maskapai" class="form-control" id="maskapai" aria-describedby="emailHelp" value="<?= $data->nama_maskapai; ?>" placeholder="e.g Garuda Indonesia">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="tiket" class="form-label">Jenis Tiket</label>
                                                                <input type="text" name="jenis_pesawat" class="form-control" id="tiket" aria-describedby="emailHelp" value="<?= $data->jenis_pesawat; ?>" placeholder="Ekonomi / Executive">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="logo" class="form-control" id="logo" aria-describedby="emailHelp" value="<?= $data->logo; ?>" placeholder="e.g ./img/product02.png">
                                                            </div>
                                                            <button type="submit" name="edit_data_pesawat" class="btn btn-primary">Submit</button>
                                                        </form>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="controller.php" method="post">
                            <div class="mb-3">
                                <label for="maskapai" class="form-label">Nama Maskapai</label>
                                <input type="text" name="nama_maskapai" class="form-control" id="maskapai" aria-describedby="emailHelp" placeholder="e.g Garuda Indonesia">
                            </div>
                            <div class="mb-3">
                                <label for="tiket" class="form-label">Jenis Tiket</label>
                                <input type="text" name="jenis_pesawat" class="form-control" id="tiket" aria-describedby="emailHelp" placeholder="Ekonomi / Executive">
                            </div>
                            <div class="mb-3">
                                <label for="destinasi" class="form-label">Destinasi</label>
                            ...
                            <div class="mb-3">
                                <label for="logo" class="form-label">Logo</label>
                                <input type="text" name="logo" class="form-control" id="logo" aria-describedby="emailHelp" placeholder="e.g ./img/product02.png">
                            </div>
                            <button type="submit" name="tambah_data_pesawat" class="btn btn-primary">Submit</button>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
